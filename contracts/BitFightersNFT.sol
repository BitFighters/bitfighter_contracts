...
contract BitFightersNFT is ERC721URIStorage, Ownable {
    ...
    function mintMultiBitfighter(
        ...
        IGameLogic(gameLogicContractAddress).mintMultiBitFighter(
            _sender,
            _partner,
            _support,
            _tokenURIs.length
